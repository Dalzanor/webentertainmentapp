const mediaData = [
  ...
  },
  {
    ...
    thumbnail: {
      trending: {
        small:
          process.env.PUBLIC_URL + "/assets/thumbnails/1998/trending/small.jpg",
        large:
          process.env.PUBLIC_URL + "/assets/thumbnails/1998/trending/large.jpg",
      },
      regular: {
        small:
          process.env.PUBLIC_URL + "/assets/thumbnails/1998/regular/small.jpg",
        medium:
          process.env.PUBLIC_URL + "/assets/thumbnails/1998/regular/medium.jpg",
        large:
          process.env.PUBLIC_URL + "/assets/thumbnails/1998/regular/large.jpg",
      },
    },
    year: 2021,
    category: "Movie",
  ...
  },
  {
    ...
    thumbnail: {
      regular: {
        small:
          process.env.PUBLIC_URL + "/assets/thumbnails/112/regular/small.jpg",
        medium:
          process.env.PUBLIC_URL + "/assets/thumbnails/112/regular/medium.jpg",
        large:
          process.env.PUBLIC_URL + "/assets/thumbnails/112/regular/large.jpg",
      },
    },
    year: 2013,
    category: "TV Series",
  ...
  },
  {
    ...
    thumbnail: {
      regular: {
        small:
          process.env.PUBLIC_URL + "/assets/thumbnails/dogs/regular/small.jpg",
        medium:
          process.env.PUBLIC_URL + "/assets/thumbnails/dogs/regular/medium.jpg",
        large:
          process.env.PUBLIC_URL + "/assets/thumbnails/dogs/regular/large.jpg",
      },
    },
    year: 2016,
    category: "TV Series",
